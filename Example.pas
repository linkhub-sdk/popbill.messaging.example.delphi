...
begin
        ...
        { - 메시지 내용 길이가 90Byte 이상인 경우, 길이를 초과하는 메시지 내용은
        {   자동으로 제거됩니다.
        { - 팝빌에 등록되지 않은 발신번호로 메시지를 전송하는 경우 발신번호 미등록
        {   오류로 처리됩니다.
...
begin
        ...
        { - 메시지 내용 길이가 2000Byte 이상인 경우, 길이를 초과하는 메시지 내용은
        {   자동으로 제거됩니다.
        { - 팝빌에 등록되지 않은 발신번호로 메시지를 전송하는 경우 발신번호 미등록
        {   오류로 처리됩니다.
...
begin
        {**********************************************************************}
        { 문자전송요청시 발급받은 접수번호(receiptNum)로  예약문자 전송을 취소합니다. (예약시간 10분 전까지 가능)
...
begin
        {**********************************************************************}
        { 검색조건에 따라 문자전송 내역을 조회합니다. (조회기간 단위 : 최대 2개월)
...
begin
        {**********************************************************************}
        { 문자전송시 할당한 전송요청번호(requestNum)로 예약문자 전송을 취소합니다. (예약시간 10분 전까지 가능)
